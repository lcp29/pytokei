...
fn language_type_mapper(lang_type: &str) -> Result<LanguageType, pyo3::PyErr> {
    match lang_type {
        ...
        "EdgeDB Schema Definition" => Ok(LanguageType::ESDL),
        "Ebuild" => Ok(LanguageType::Ebuild),
        "EdgeQL" => Ok(LanguageType::EdgeQL),
        ...
        "Korn shell" => Ok(LanguageType::Ksh),
        "KV Language" => Ok(LanguageType::KvLanguage),
        ...
        "Metal Shading Language" => Ok(LanguageType::Metal),
        ...
        "Open Policy Agent" => Ok(LanguageType::OpenPolicyAgent),
        ...
        "Raku" => Ok(LanguageType::Raku),
        "Razor" => Ok(LanguageType::Razor),
        "ReScript" => Ok(LanguageType::ReScript),
        "ReStructuredText" => Ok(LanguageType::ReStructuredText),
        "Redscript" => Ok(LanguageType::Redscript),
        ...
        "Smalltalk" => Ok(LanguageType::Smalltalk),
        ...
        "WebGPU Shader Language" => Ok(LanguageType::WGSL),
        "WebAssembly" => Ok(LanguageType::WebAssembly),
        "The WenYan Programming Language" => Ok(LanguageType::WenYan),
